<div class="container mt-20 pb-20 md:pb-8">
    <div class="bg-background-secondary border border-neutral/20 p-6 rounded-lg mt-2">
        ...
        <div class="md:grid grid-cols-4 flex flex-col gap-4">
            <div class="md:col-span-3">
                ...
                <div class="mt-4">
                    <form wire:submit.prevent="save">
                        <label for="editor" class="block text-sm font-medium text-base/70">
                            {{ __('ticket.reply') }}
                        </label>
                        <div wire:ignore>
                            <textarea id="editor"></textarea>
                        </div>
                        <label for="attachments" class="block text-sm font-medium text-base/70 mt-2">
                        ...
                        <div x-data="{
                            ...
                            <div class="flex justify-center rounded-lg bg-background-secondary border border-dashed border-neutral px-6 py-2"
                                ...
                                <div x-show="uploading" class="w-full text-center">
                                    <div class="mb-2 text-sm font-medium text-base/70">
                                ...
                                <template x-if="selectedFiles.length === 0 && !uploading">
                                    <div class="text-center">
                                        <div class="flex text-sm text-base/70">
            ...
            <div class="md:order-last order-first w-full col-span-3 sm:col-auto">
                ...
                <div class="flex flex-col w-full col-span-1">
                    <h2 class="text-2xl font-semibold bg-background-secondary border border-neutral/20 p-2 px-4 rounded-md mb-2">
                        {{ __('ticket.ticket_details') }}
                    </h2>
                    <div class="font-semibold flex md:flex-col justify-between bg-background-secondary border border-neutral/20 p-2 px-4 rounded-md gap-2">
                        <h4 class="h-fit">{{ __('ticket.subject') }}:</h4> {{ $ticket->subject }}
                    </div>
                    <div class="font-semibold flex md:flex-col justify-between bg-background-secondary border border-neutral/20 p-2 px-4 rounded-md">
