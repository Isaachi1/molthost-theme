        ...
        <x-modal :title="__('account.payment_methods')" open="true">
            <x-slot name="closeTrigger">
                <div class="flex gap-4">
                    <button wire:click="$set('setupModalVisible', false)" class="text-base/70">
                ...
                <x-slot name="closeTrigger">
                    <div class="flex gap-4">
                        <button wire:confirm="Are you sure?" wire:click="cancelSetup" wire:loading.attr="disabled"
                            wire:target="cancelSetup" class="text-base/70">
                            <x-ri-close-fill class="size-6" />
                        </button>
                    </div>
                </x-slot>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="font-medium">
                            {{ $transaction->transaction_id ? __('molthost::messages.account.transaction_label') . ' ' . $transaction->transaction_id : __('molthost::messages.account.transaction_id_na') }}
                        </span>
                        ...
                        <span class="text-base text-sm">
                            ...
                            {{ __('molthost::messages.account.using') }}
                            {{ $transaction->gateway ? $transaction->gateway->name : __('molthost::messages.account.gateway_na') }}
                        </span>
                    </div>
                    <div class="pr-2">
